...
* **Identity and character** — studying how LLMs form and maintain self-concepts, and how these can shift under different conditions.
* **Inter-agent dynamics** — examining the social behavior of interacting LLM agents, including persona transfer, cultural dynamics, and emergent cooperation.
* **Representation engineering** — developing tools and methods for understanding and steering the internal representations of language models.
...
**Jan Kulveit**, **Gavin Leech**, **Tomáš Gavenčiak**, **Raymond Douglas**: *Position: AI Evaluation Should Work With Humans.* July 2026, [arXiv](https://arxiv.org/abs/2608.13577)
...
**Jan Kulveit**, **Raymond Douglas**, **Nora Ammann**, Deger Turan, David Krueger, David Duvenaud: *Gradual Disempowerment: Systemic Existential Risks from Incremental AI Development.* Jan 2025, [arXiv](https://arxiv.org/abs/2501.16946), [website](https://gradual-disempowerment.ai/). Published at [ICML 2025](https://proceedings.mlr.press/v267/kulveit25a.html).
...
**Raymond Douglas**, Andis Draguns, **Tomáš Gavenčiak**: *Mitigating the Influence of Distractor Tasks in LMs with Prior-Aware Decoding.* January 2024, [arXiv](https://arxiv.org/abs/2401.17692)
